...
// ISPFBLGuidesAPIService ISPFBLGuidesAPI service
type ISPFBLGuidesAPIService service

type ApiGetIspFblGuideRequest struct {
	ctx context.Context
	ApiService *ISPFBLGuidesAPIService
	ispId string
}

func (r ApiGetIspFblGuideRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetIspFblGuideExecute(r)
}

/*
GetIspFblGuide Get ISP FBL guide

Retrieve a specific ISP feedback loop setup guide.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ispId
 @return ApiGetIspFblGuideRequest
*/
func (a *ISPFBLGuidesAPIService) GetIspFblGuide(ctx context.Context, ispId string) ApiGetIspFblGuideRequest {
	return ApiGetIspFblGuideRequest{
		ApiService: a,
		ctx: ctx,
		ispId: ispId,
...
func (a *ISPFBLGuidesAPIService) GetIspFblGuideExecute(r ApiGetIspFblGuideRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ISPFBLGuidesAPIService.GetIspFblGuide")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/isp-fbl/guides/{isp_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"isp_id"+"}", url.PathEscape(parameterValueToString(r.ispId, "ispId")), -1)
...
type ApiListIspFblGuidesRequest struct {
	ctx context.Context
	ApiService *ISPFBLGuidesAPIService
}

func (r ApiListIspFblGuidesRequest) Execute() (*http.Response, error) {
	return r.ApiService.ListIspFblGuidesExecute(r)
}

/*
ListIspFblGuides List ISP FBL guides

List all ISP feedback loop setup guides.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListIspFblGuidesRequest
*/
func (a *ISPFBLGuidesAPIService) ListIspFblGuides(ctx context.Context) ApiListIspFblGuidesRequest {
	return ApiListIspFblGuidesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ISPFBLGuidesAPIService) ListIspFblGuidesExecute(r ApiListIspFblGuidesRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ISPFBLGuidesAPIService.ListIspFblGuides")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/isp-fbl/guides"
