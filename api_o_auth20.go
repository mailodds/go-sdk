...
type ApiOauthRegisterClientRequest struct {
	ctx context.Context
	ApiService *OAuth20APIService
}

func (r ApiOauthRegisterClientRequest) Execute() (*OAuthClientRegistration, *http.Response, error) {
	return r.ApiService.OauthRegisterClientExecute(r)
}

/*
OauthRegisterClient Register OAuth client

Dynamic Client Registration (RFC 7591). Allows MCP clients to auto-register without user interaction.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiOauthRegisterClientRequest
*/
func (a *OAuth20APIService) OauthRegisterClient(ctx context.Context) ApiOauthRegisterClientRequest {
	return ApiOauthRegisterClientRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OAuth20APIService) OauthRegisterClientExecute(r ApiOauthRegisterClientRequest) (*OAuthClientRegistration, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OAuthClientRegistration
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth20APIService.OauthRegisterClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
