...
// DeliverabilityAdvisorAPIService DeliverabilityAdvisorAPI service
type DeliverabilityAdvisorAPIService service

type ApiDismissDeliverabilityRecommendationRequest struct {
	ctx context.Context
	ApiService *DeliverabilityAdvisorAPIService
	recommendationId string
}

func (r ApiDismissDeliverabilityRecommendationRequest) Execute() (*http.Response, error) {
	return r.ApiService.DismissDeliverabilityRecommendationExecute(r)
}

/*
DismissDeliverabilityRecommendation Dismiss a deliverability recommendation

Dismiss a deliverability recommendation so it no longer appears.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param recommendationId
 @return ApiDismissDeliverabilityRecommendationRequest
*/
func (a *DeliverabilityAdvisorAPIService) DismissDeliverabilityRecommendation(ctx context.Context, recommendationId string) ApiDismissDeliverabilityRecommendationRequest {
	return ApiDismissDeliverabilityRecommendationRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *DeliverabilityAdvisorAPIService) DismissDeliverabilityRecommendationExecute(r ApiDismissDeliverabilityRecommendationRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeliverabilityAdvisorAPIService.DismissDeliverabilityRecommendation")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/deliverability/recommendations/{recommendation_id}/dismiss"
...
type ApiGetDeliverabilityRecommendationsRequest struct {
	ctx context.Context
	ApiService *DeliverabilityAdvisorAPIService
}

func (r ApiGetDeliverabilityRecommendationsRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetDeliverabilityRecommendationsExecute(r)
}

/*
GetDeliverabilityRecommendations Get deliverability recommendations

Retrieve actionable deliverability recommendations for the account.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetDeliverabilityRecommendationsRequest
*/
func (a *DeliverabilityAdvisorAPIService) GetDeliverabilityRecommendations(ctx context.Context) ApiGetDeliverabilityRecommendationsRequest {
	return ApiGetDeliverabilityRecommendationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *DeliverabilityAdvisorAPIService) GetDeliverabilityRecommendationsExecute(r ApiGetDeliverabilityRecommendationsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeliverabilityAdvisorAPIService.GetDeliverabilityRecommendations")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/deliverability/recommendations"
