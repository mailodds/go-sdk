...
// SenderHealthAPIService SenderHealthAPI service
type SenderHealthAPIService service

type ApiGetSenderHealthRequest struct {
	ctx context.Context
	ApiService *SenderHealthAPIService
	period *string
}

// Time period for health calculation
func (r ApiGetSenderHealthRequest) Period(period string) ApiGetSenderHealthRequest {
	r.period = &period
	return r
}

func (r ApiGetSenderHealthRequest) Execute() (*GetSenderHealth200Response, *http.Response, error) {
	return r.ApiService.GetSenderHealthExecute(r)
}

/*
GetSenderHealth Get sender health score
...
Get an aggregate sender health score (0-100) across all sending domains. Factors in delivery rate, bounce rate, complaint rate, and authentication status.
 ...
 @return ApiGetSenderHealthRequest
*/
func (a *SenderHealthAPIService) GetSenderHealth(ctx context.Context) ApiGetSenderHealthRequest {
	return ApiGetSenderHealthRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SenderHealthAPIService) GetSenderHealthExecute(r ApiGetSenderHealthRequest) (*GetSenderHealth200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSenderHealth200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SenderHealthAPIService.GetSenderHealth")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/sender-health"
...
type ApiGetSenderHealthTrendRequest struct {
	ctx context.Context
	ApiService *SenderHealthAPIService
	period *string
}
...
func (r ApiGetSenderHealthTrendRequest) Period(period string) ApiGetSenderHealthTrendRequest {
	r.period = &period
	return r
}

func (r ApiGetSenderHealthTrendRequest) Execute() (*GetSenderHealthTrend200Response, *http.Response, error) {
	return r.ApiService.GetSenderHealthTrendExecute(r)
}

/*
GetSenderHealthTrend Get sender health trend

Get historical sender health scores over time for trend analysis. Returns daily data points for the requested period.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetSenderHealthTrendRequest
*/
func (a *SenderHealthAPIService) GetSenderHealthTrend(ctx context.Context) ApiGetSenderHealthTrendRequest {
	return ApiGetSenderHealthTrendRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SenderHealthAPIService) GetSenderHealthTrendExecute(r ApiGetSenderHealthTrendRequest) (*GetSenderHealthTrend200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSenderHealthTrend200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SenderHealthAPIService.GetSenderHealthTrend")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/sender-health/trend"
