...
// checks if the SuppressionAuditResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuppressionAuditResponse{}

// SuppressionAuditResponse struct for SuppressionAuditResponse
type SuppressionAuditResponse struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	// Unique request identifier
	RequestId *string `json:"request_id,omitempty"`
	Entries []SuppressionAuditResponseEntriesInner `json:"entries,omitempty"`
...
func (o *SuppressionAuditResponse) GetEntries() []SuppressionAuditResponseEntriesInner {
	if o == nil || IsNil(o.Entries) {
		var ret []SuppressionAuditResponseEntriesInner
		return ret
	}
	return o.Entries
}
...
// SetEntries gets a reference to the given []SuppressionAuditResponseEntriesInner and assigns it to the Entries field.
...
func (o SuppressionAuditResponse) MarshalJSON() ([]byte, error) {
...
func (o SuppressionAuditResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSuppressionAuditResponse struct {
	value *SuppressionAuditResponse
	isSet bool
}

func (v NullableSuppressionAuditResponse) Get() *SuppressionAuditResponse {
	return v.value
}

func (v *NullableSuppressionAuditResponse) Set(val *SuppressionAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSuppressionAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSuppressionAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuppressionAuditResponse(val *SuppressionAuditResponse) *NullableSuppressionAuditResponse {
	return &NullableSuppressionAuditResponse{value: val, isSet: true}
}

func (v NullableSuppressionAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuppressionAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
