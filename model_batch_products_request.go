...
// checks if the BatchProductsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchProductsRequest{}

// BatchProductsRequest struct for BatchProductsRequest
type BatchProductsRequest struct {
	Products []BatchProductsRequestProductsInner `json:"products"`
}

type _BatchProductsRequest BatchProductsRequest
...
func (o *BatchProductsRequest) GetProducts() []BatchProductsRequestProductsInner {
	if o == nil {
		var ret []BatchProductsRequestProductsInner
		return ret
	}
...
func (o BatchProductsRequest) MarshalJSON() ([]byte, error) {
...
func (o BatchProductsRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["products"] = o.Products
	return toSerialize, nil
}

func (o *BatchProductsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchProductsRequest := _BatchProductsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchProductsRequest)

	if err != nil {
		return err
	}

	*o = BatchProductsRequest(varBatchProductsRequest)

	return err
}

type NullableBatchProductsRequest struct {
	value *BatchProductsRequest
	isSet bool
}

func (v NullableBatchProductsRequest) Get() *BatchProductsRequest {
	return v.value
}

func (v *NullableBatchProductsRequest) Set(val *BatchProductsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchProductsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchProductsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchProductsRequest(val *BatchProductsRequest) *NullableBatchProductsRequest {
	return &NullableBatchProductsRequest{value: val, isSet: true}
}

func (v NullableBatchProductsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchProductsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
