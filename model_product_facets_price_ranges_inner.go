...
// checks if the ProductFacetsPriceRangesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFacetsPriceRangesInner{}

// ProductFacetsPriceRangesInner struct for ProductFacetsPriceRangesInner
type ProductFacetsPriceRangesInner struct {
	// Price range label (e.g., '0-10', '500+')
	Range *string `json:"range,omitempty"`
	Count *int32 `json:"count,omitempty"`
}

// NewProductFacetsPriceRangesInner instantiates a new ProductFacetsPriceRangesInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewProductFacetsPriceRangesInner() *ProductFacetsPriceRangesInner {
	this := ProductFacetsPriceRangesInner{}
	return &this
}

// NewProductFacetsPriceRangesInnerWithDefaults instantiates a new ProductFacetsPriceRangesInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewProductFacetsPriceRangesInnerWithDefaults() *ProductFacetsPriceRangesInner {
	this := ProductFacetsPriceRangesInner{}
	return &this
}

// GetRange returns the Range field value if set, zero value otherwise.
func (o *ProductFacetsPriceRangesInner) GetRange() string {
...
func (o *ProductFacetsPriceRangesInner) GetRangeOk() (*string, bool) {
	if o == nil || IsNil(o.Range) {
		return nil, false
	}
	return o.Range, true
...
func (o *ProductFacetsPriceRangesInner) HasRange() bool {
	if o != nil && !IsNil(o.Range) {
		return true
	}
...
func (o *ProductFacetsPriceRangesInner) SetRange(v string) {
	o.Range = &v
}

// GetCount returns the Count field value if set, zero value otherwise.
func (o *ProductFacetsPriceRangesInner) GetCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *ProductFacetsPriceRangesInner) GetCountOk() (*int32, bool) {
	if o == nil || IsNil(o.Count) {
		return nil, false
	}
	return o.Count, true
...
func (o *ProductFacetsPriceRangesInner) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o *ProductFacetsPriceRangesInner) SetCount(v int32) {
	o.Count = &v
}

func (o ProductFacetsPriceRangesInner) MarshalJSON() ([]byte, error) {
...
func (o ProductFacetsPriceRangesInner) ToMap() (map[string]interface{}, error) {
...
type NullableProductFacetsPriceRangesInner struct {
	value *ProductFacetsPriceRangesInner
	isSet bool
}

func (v NullableProductFacetsPriceRangesInner) Get() *ProductFacetsPriceRangesInner {
	return v.value
}

func (v *NullableProductFacetsPriceRangesInner) Set(val *ProductFacetsPriceRangesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProductFacetsPriceRangesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProductFacetsPriceRangesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductFacetsPriceRangesInner(val *ProductFacetsPriceRangesInner) *NullableProductFacetsPriceRangesInner {
	return &NullableProductFacetsPriceRangesInner{value: val, isSet: true}
}

func (v NullableProductFacetsPriceRangesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductFacetsPriceRangesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
