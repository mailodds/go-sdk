...
// checks if the GetBounceRecords200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBounceRecords200Response{}

// GetBounceRecords200Response struct for GetBounceRecords200Response
type GetBounceRecords200Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	// Unique request identifier
	RequestId *string `json:"request_id,omitempty"`
	Records []GetBounceRecords200ResponseRecordsInner `json:"records,omitempty"`
...
func NewGetBounceRecords200Response() *GetBounceRecords200Response {
	this := GetBounceRecords200Response{}
	return &this
}
...
func (o *GetBounceRecords200Response) GetRecords() []GetBounceRecords200ResponseRecordsInner {
	if o == nil || IsNil(o.Records) {
		var ret []GetBounceRecords200ResponseRecordsInner
		return ret
	}
	return o.Records
}
...
// SetRecords gets a reference to the given []GetBounceRecords200ResponseRecordsInner and assigns it to the Records field.
...
func (o GetBounceRecords200Response) MarshalJSON() ([]byte, error) {
...
func (o GetBounceRecords200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetBounceRecords200Response struct {
	value *GetBounceRecords200Response
	isSet bool
}

func (v NullableGetBounceRecords200Response) Get() *GetBounceRecords200Response {
	return v.value
}

func (v *NullableGetBounceRecords200Response) Set(val *GetBounceRecords200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBounceRecords200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBounceRecords200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBounceRecords200Response(val *GetBounceRecords200Response) *NullableGetBounceRecords200Response {
	return &NullableGetBounceRecords200Response{value: val, isSet: true}
}

func (v NullableGetBounceRecords200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBounceRecords200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
