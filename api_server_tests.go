...
// ServerTestsAPIService ServerTestsAPI service
type ServerTestsAPIService service

type ApiGetServerTestRequest struct {
	ctx context.Context
	ApiService *ServerTestsAPIService
	testId string
}

func (r ApiGetServerTestRequest) Execute() (*RunServerTest201Response, *http.Response, error) {
	return r.ApiService.GetServerTestExecute(r)
}

/*
GetServerTest Get server test
...
func (a *ServerTestsAPIService) GetServerTestExecute(r ApiGetServerTestRequest) (*RunServerTest201Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RunServerTest201Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerTestsAPIService.GetServerTest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/server-tests/{test_id}"
...
type ApiListServerTestsRequest struct {
	ctx context.Context
	ApiService *ServerTestsAPIService
	page *int32
	perPage *int32
...
func (r ApiListServerTestsRequest) Page(page int32) ApiListServerTestsRequest {
	r.page = &page
	return r
}

func (r ApiListServerTestsRequest) PerPage(perPage int32) ApiListServerTestsRequest {
	r.perPage = &perPage
	return r
}

func (r ApiListServerTestsRequest) Execute() (*ListServerTests200Response, *http.Response, error) {
	return r.ApiService.ListServerTestsExecute(r)
}

/*
ListServerTests List server tests

List past server test results with pagination.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListServerTestsRequest
*/
func (a *ServerTestsAPIService) ListServerTests(ctx context.Context) ApiListServerTestsRequest {
	return ApiListServerTestsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ServerTestsAPIService) ListServerTestsExecute(r ApiListServerTestsRequest) (*ListServerTests200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListServerTests200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerTestsAPIService.ListServerTests")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/server-tests"
...
type ApiRunServerTestRequest struct {
	ctx context.Context
	ApiService *ServerTestsAPIService
	runServerTestRequest *RunServerTestRequest
}

func (r ApiRunServerTestRequest) RunServerTestRequest(runServerTestRequest RunServerTestRequest) ApiRunServerTestRequest {
	r.runServerTestRequest = &runServerTestRequest
	return r
}

func (r ApiRunServerTestRequest) Execute() (*RunServerTest201Response, *http.Response, error) {
	return r.ApiService.RunServerTestExecute(r)
}
...
Run an SMTP handshake test and MX configuration audit for a domain.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRunServerTestRequest
*/
func (a *ServerTestsAPIService) RunServerTest(ctx context.Context) ApiRunServerTestRequest {
	return ApiRunServerTestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return RunServerTest201Response
func (a *ServerTestsAPIService) RunServerTestExecute(r ApiRunServerTestRequest) (*RunServerTest201Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerTestsAPIService.RunServerTest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.runServerTestRequest == nil {
		return localVarReturnValue, nil, reportError("runServerTestRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.runServerTestRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
