...
// checks if the CreateStore201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateStore201Response{}

// CreateStore201Response struct for CreateStore201Response
type CreateStore201Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	Store *StoreConnection `json:"store,omitempty"`
}
...
// SetStore gets a reference to the given StoreConnection and assigns it to the Store field.
func (o *CreateStore201Response) SetStore(v StoreConnection) {
	o.Store = &v
}

func (o CreateStore201Response) MarshalJSON() ([]byte, error) {
...
func (o CreateStore201Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateStore201Response struct {
	value *CreateStore201Response
	isSet bool
}

func (v NullableCreateStore201Response) Get() *CreateStore201Response {
	return v.value
}

func (v *NullableCreateStore201Response) Set(val *CreateStore201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateStore201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateStore201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateStore201Response(val *CreateStore201Response) *NullableCreateStore201Response {
	return &NullableCreateStore201Response{value: val, isSet: true}
}

func (v NullableCreateStore201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateStore201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
