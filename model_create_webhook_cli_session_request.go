...
// checks if the CreateWebhookCliSessionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateWebhookCliSessionRequest{}

// CreateWebhookCliSessionRequest struct for CreateWebhookCliSessionRequest
type CreateWebhookCliSessionRequest struct {
...
func NewCreateWebhookCliSessionRequest() *CreateWebhookCliSessionRequest {
	this := CreateWebhookCliSessionRequest{}
	return &this
}
...
func (o CreateWebhookCliSessionRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateWebhookCliSessionRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateWebhookCliSessionRequest struct {
	value *CreateWebhookCliSessionRequest
	isSet bool
}

func (v NullableCreateWebhookCliSessionRequest) Get() *CreateWebhookCliSessionRequest {
	return v.value
}

func (v *NullableCreateWebhookCliSessionRequest) Set(val *CreateWebhookCliSessionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateWebhookCliSessionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateWebhookCliSessionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateWebhookCliSessionRequest(val *CreateWebhookCliSessionRequest) *NullableCreateWebhookCliSessionRequest {
	return &NullableCreateWebhookCliSessionRequest{value: val, isSet: true}
}

func (v NullableCreateWebhookCliSessionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateWebhookCliSessionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
