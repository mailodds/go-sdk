...
// checks if the BounceAnalysisResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BounceAnalysisResponse{}

// BounceAnalysisResponse struct for BounceAnalysisResponse
type BounceAnalysisResponse struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	// Unique request identifier
	RequestId *string `json:"request_id,omitempty"`
	Analysis *BounceAnalysisResponseAnalysis `json:"analysis,omitempty"`
}
...
func (o *BounceAnalysisResponse) GetAnalysis() BounceAnalysisResponseAnalysis {
	if o == nil || IsNil(o.Analysis) {
		var ret BounceAnalysisResponseAnalysis
		return ret
	}
	return *o.Analysis
}
...
// SetAnalysis gets a reference to the given BounceAnalysisResponseAnalysis and assigns it to the Analysis field.
func (o *BounceAnalysisResponse) SetAnalysis(v BounceAnalysisResponseAnalysis) {
	o.Analysis = &v
}

func (o BounceAnalysisResponse) MarshalJSON() ([]byte, error) {
...
func (o BounceAnalysisResponse) ToMap() (map[string]interface{}, error) {
...
type NullableBounceAnalysisResponse struct {
	value *BounceAnalysisResponse
	isSet bool
}

func (v NullableBounceAnalysisResponse) Get() *BounceAnalysisResponse {
	return v.value
}

func (v *NullableBounceAnalysisResponse) Set(val *BounceAnalysisResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBounceAnalysisResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBounceAnalysisResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBounceAnalysisResponse(val *BounceAnalysisResponse) *NullableBounceAnalysisResponse {
	return &NullableBounceAnalysisResponse{value: val, isSet: true}
}

func (v NullableBounceAnalysisResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBounceAnalysisResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
