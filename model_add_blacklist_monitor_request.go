...
// checks if the AddBlacklistMonitorRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddBlacklistMonitorRequest{}

// AddBlacklistMonitorRequest struct for AddBlacklistMonitorRequest
type AddBlacklistMonitorRequest struct {
...
type _AddBlacklistMonitorRequest AddBlacklistMonitorRequest
...
func NewAddBlacklistMonitorRequest(target string, targetType string) *AddBlacklistMonitorRequest {
	this := AddBlacklistMonitorRequest{}
	this.Target = target
...
func (o AddBlacklistMonitorRequest) MarshalJSON() ([]byte, error) {
...
func (o AddBlacklistMonitorRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AddBlacklistMonitorRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAddBlacklistMonitorRequest := _AddBlacklistMonitorRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddBlacklistMonitorRequest)

	if err != nil {
		return err
	}

	*o = AddBlacklistMonitorRequest(varAddBlacklistMonitorRequest)

	return err
}

type NullableAddBlacklistMonitorRequest struct {
	value *AddBlacklistMonitorRequest
	isSet bool
}

func (v NullableAddBlacklistMonitorRequest) Get() *AddBlacklistMonitorRequest {
	return v.value
}

func (v *NullableAddBlacklistMonitorRequest) Set(val *AddBlacklistMonitorRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddBlacklistMonitorRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddBlacklistMonitorRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddBlacklistMonitorRequest(val *AddBlacklistMonitorRequest) *NullableAddBlacklistMonitorRequest {
	return &NullableAddBlacklistMonitorRequest{value: val, isSet: true}
}

func (v NullableAddBlacklistMonitorRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddBlacklistMonitorRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
