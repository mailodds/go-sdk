...
// PixelSettingsAPIService PixelSettingsAPI service
type PixelSettingsAPIService service

type ApiGetPixelSettingsRequest struct {
	ctx context.Context
	ApiService *PixelSettingsAPIService
}

func (r ApiGetPixelSettingsRequest) Execute() (*GetPixelSettings200Response, *http.Response, error) {
	return r.ApiService.GetPixelSettingsExecute(r)
}

/*
GetPixelSettings Get pixel settings

Get the web pixel tracking configuration.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetPixelSettingsRequest
*/
func (a *PixelSettingsAPIService) GetPixelSettings(ctx context.Context) ApiGetPixelSettingsRequest {
	return ApiGetPixelSettingsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PixelSettingsAPIService) GetPixelSettingsExecute(r ApiGetPixelSettingsRequest) (*GetPixelSettings200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetPixelSettings200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PixelSettingsAPIService.GetPixelSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/pixel-settings"
...
type ApiUpdatePixelSettingsRequest struct {
	ctx context.Context
	ApiService *PixelSettingsAPIService
	updatePixelSettingsRequest *UpdatePixelSettingsRequest
}

func (r ApiUpdatePixelSettingsRequest) UpdatePixelSettingsRequest(updatePixelSettingsRequest UpdatePixelSettingsRequest) ApiUpdatePixelSettingsRequest {
	r.updatePixelSettingsRequest = &updatePixelSettingsRequest
	return r
}

func (r ApiUpdatePixelSettingsRequest) Execute() (*GetPixelSettings200Response, *http.Response, error) {
	return r.ApiService.UpdatePixelSettingsExecute(r)
}

/*
UpdatePixelSettings Update pixel settings

Update the web pixel subscribe list configuration.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUpdatePixelSettingsRequest
*/
func (a *PixelSettingsAPIService) UpdatePixelSettings(ctx context.Context) ApiUpdatePixelSettingsRequest {
	return ApiUpdatePixelSettingsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetPixelSettings200Response
func (a *PixelSettingsAPIService) UpdatePixelSettingsExecute(r ApiUpdatePixelSettingsRequest) (*GetPixelSettings200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PixelSettingsAPIService.UpdatePixelSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updatePixelSettingsRequest == nil {
		return localVarReturnValue, nil, reportError("updatePixelSettingsRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updatePixelSettingsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
