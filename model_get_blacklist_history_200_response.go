...
// checks if the GetBlacklistHistory200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBlacklistHistory200Response{}

// GetBlacklistHistory200Response struct for GetBlacklistHistory200Response
type GetBlacklistHistory200Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	Checks []GetBlacklistHistory200ResponseChecksInner `json:"checks,omitempty"`
...
func NewGetBlacklistHistory200Response() *GetBlacklistHistory200Response {
	this := GetBlacklistHistory200Response{}
	return &this
}
...
func (o *GetBlacklistHistory200Response) GetChecks() []GetBlacklistHistory200ResponseChecksInner {
	if o == nil || IsNil(o.Checks) {
		var ret []GetBlacklistHistory200ResponseChecksInner
		return ret
	}
	return o.Checks
}
...
// SetChecks gets a reference to the given []GetBlacklistHistory200ResponseChecksInner and assigns it to the Checks field.
...
func (o GetBlacklistHistory200Response) MarshalJSON() ([]byte, error) {
...
func (o GetBlacklistHistory200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetBlacklistHistory200Response struct {
	value *GetBlacklistHistory200Response
	isSet bool
}

func (v NullableGetBlacklistHistory200Response) Get() *GetBlacklistHistory200Response {
	return v.value
}

func (v *NullableGetBlacklistHistory200Response) Set(val *GetBlacklistHistory200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlacklistHistory200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlacklistHistory200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlacklistHistory200Response(val *GetBlacklistHistory200Response) *NullableGetBlacklistHistory200Response {
	return &NullableGetBlacklistHistory200Response{value: val, isSet: true}
}

func (v NullableGetBlacklistHistory200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlacklistHistory200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
