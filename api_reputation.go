...
type ApiGetReputationRequest struct {
	ctx context.Context
	ApiService *ReputationAPIService
	period *string
}

// Evaluation period
func (r ApiGetReputationRequest) Period(period string) ApiGetReputationRequest {
	r.period = &period
	return r
}

func (r ApiGetReputationRequest) Execute() (*GetReputation200Response, *http.Response, error) {
	return r.ApiService.GetReputationExecute(r)
}
...
Get the aggregate reputation score and breakdown for the account.
 ...
 @return ApiGetReputationRequest
*/
func (a *ReputationAPIService) GetReputation(ctx context.Context) ApiGetReputationRequest {
	return ApiGetReputationRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ReputationAPIService) GetReputationExecute(r ApiGetReputationRequest) (*GetReputation200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetReputation200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReputationAPIService.GetReputation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/reputation"
...
type ApiGetReputationTimelineRequest struct {
	ctx context.Context
	ApiService *ReputationAPIService
	period *string
}
...
// Timeline period
func (r ApiGetReputationTimelineRequest) Period(period string) ApiGetReputationTimelineRequest {
	r.period = &period
	return r
}

func (r ApiGetReputationTimelineRequest) Execute() (*GetReputationTimeline200Response, *http.Response, error) {
	return r.ApiService.GetReputationTimelineExecute(r)
}

/*
GetReputationTimeline Get reputation timeline

Get reputation metrics over time.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetReputationTimelineRequest
*/
func (a *ReputationAPIService) GetReputationTimeline(ctx context.Context) ApiGetReputationTimelineRequest {
	return ApiGetReputationTimelineRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ReputationAPIService) GetReputationTimelineExecute(r ApiGetReputationTimelineRequest) (*GetReputationTimeline200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetReputationTimeline200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReputationAPIService.GetReputationTimeline")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/reputation/timeline"
