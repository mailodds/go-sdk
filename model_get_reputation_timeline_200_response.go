...
// checks if the GetReputationTimeline200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetReputationTimeline200Response{}

// GetReputationTimeline200Response struct for GetReputationTimeline200Response
type GetReputationTimeline200Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	Timeline *GetReputationTimeline200ResponseTimeline `json:"timeline,omitempty"`
}
...
func NewGetReputationTimeline200Response() *GetReputationTimeline200Response {
	this := GetReputationTimeline200Response{}
	return &this
}
...
func (o *GetReputationTimeline200Response) GetTimeline() GetReputationTimeline200ResponseTimeline {
	if o == nil || IsNil(o.Timeline) {
		var ret GetReputationTimeline200ResponseTimeline
		return ret
	}
	return *o.Timeline
}
...
// SetTimeline gets a reference to the given GetReputationTimeline200ResponseTimeline and assigns it to the Timeline field.
func (o *GetReputationTimeline200Response) SetTimeline(v GetReputationTimeline200ResponseTimeline) {
	o.Timeline = &v
}

func (o GetReputationTimeline200Response) MarshalJSON() ([]byte, error) {
...
func (o GetReputationTimeline200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetReputationTimeline200Response struct {
	value *GetReputationTimeline200Response
	isSet bool
}

func (v NullableGetReputationTimeline200Response) Get() *GetReputationTimeline200Response {
	return v.value
}

func (v *NullableGetReputationTimeline200Response) Set(val *GetReputationTimeline200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetReputationTimeline200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetReputationTimeline200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetReputationTimeline200Response(val *GetReputationTimeline200Response) *NullableGetReputationTimeline200Response {
	return &NullableGetReputationTimeline200Response{value: val, isSet: true}
}

func (v NullableGetReputationTimeline200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetReputationTimeline200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
