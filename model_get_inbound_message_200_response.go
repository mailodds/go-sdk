...
// checks if the GetInboundMessage200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetInboundMessage200Response{}

// GetInboundMessage200Response struct for GetInboundMessage200Response
type GetInboundMessage200Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	Message map[string]interface{} `json:"message,omitempty"`
}

// NewGetInboundMessage200Response instantiates a new GetInboundMessage200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetInboundMessage200Response() *GetInboundMessage200Response {
	this := GetInboundMessage200Response{}
	return &this
}

// NewGetInboundMessage200ResponseWithDefaults instantiates a new GetInboundMessage200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetInboundMessage200ResponseWithDefaults() *GetInboundMessage200Response {
	this := GetInboundMessage200Response{}
	return &this
}

// GetSchemaVersion returns the SchemaVersion field value if set, zero value otherwise.
func (o *GetInboundMessage200Response) GetSchemaVersion() string {
...
func (o *GetInboundMessage200Response) GetSchemaVersionOk() (*string, bool) {
	if o == nil || IsNil(o.SchemaVersion) {
		return nil, false
	}
...
func (o *GetInboundMessage200Response) HasSchemaVersion() bool {
	if o != nil && !IsNil(o.SchemaVersion) {
		return true
	}
...
func (o *GetInboundMessage200Response) SetSchemaVersion(v string) {
	o.SchemaVersion = &v
}

// GetRequestId returns the RequestId field value if set, zero value otherwise.
func (o *GetInboundMessage200Response) GetRequestId() string {
...
// and a boolean to check if the value has been set.
func (o *GetInboundMessage200Response) GetRequestIdOk() (*string, bool) {
	if o == nil || IsNil(o.RequestId) {
		return nil, false
	}
...
func (o *GetInboundMessage200Response) HasRequestId() bool {
	if o != nil && !IsNil(o.RequestId) {
		return true
	}
...
func (o *GetInboundMessage200Response) SetRequestId(v string) {
	o.RequestId = &v
}

// GetMessage returns the Message field value if set, zero value otherwise.
func (o *GetInboundMessage200Response) GetMessage() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *GetInboundMessage200Response) GetMessageOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Message) {
...
func (o *GetInboundMessage200Response) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *GetInboundMessage200Response) SetMessage(v map[string]interface{}) {
	o.Message = v
}

func (o GetInboundMessage200Response) MarshalJSON() ([]byte, error) {
...
func (o GetInboundMessage200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetInboundMessage200Response struct {
	value *GetInboundMessage200Response
	isSet bool
}

func (v NullableGetInboundMessage200Response) Get() *GetInboundMessage200Response {
	return v.value
}

func (v *NullableGetInboundMessage200Response) Set(val *GetInboundMessage200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetInboundMessage200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetInboundMessage200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetInboundMessage200Response(val *GetInboundMessage200Response) *NullableGetInboundMessage200Response {
	return &NullableGetInboundMessage200Response{value: val, isSet: true}
}

func (v NullableGetInboundMessage200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetInboundMessage200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
