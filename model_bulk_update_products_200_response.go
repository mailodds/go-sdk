...
// checks if the BulkUpdateProducts200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkUpdateProducts200Response{}

// BulkUpdateProducts200Response struct for BulkUpdateProducts200Response
type BulkUpdateProducts200Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	Updated *int32 `json:"updated,omitempty"`
}

// NewBulkUpdateProducts200Response instantiates a new BulkUpdateProducts200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBulkUpdateProducts200Response() *BulkUpdateProducts200Response {
	this := BulkUpdateProducts200Response{}
	return &this
}

// NewBulkUpdateProducts200ResponseWithDefaults instantiates a new BulkUpdateProducts200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBulkUpdateProducts200ResponseWithDefaults() *BulkUpdateProducts200Response {
	this := BulkUpdateProducts200Response{}
	return &this
}

// GetSchemaVersion returns the SchemaVersion field value if set, zero value otherwise.
func (o *BulkUpdateProducts200Response) GetSchemaVersion() string {
...
func (o *BulkUpdateProducts200Response) GetSchemaVersionOk() (*string, bool) {
	if o == nil || IsNil(o.SchemaVersion) {
		return nil, false
	}
...
func (o *BulkUpdateProducts200Response) HasSchemaVersion() bool {
	if o != nil && !IsNil(o.SchemaVersion) {
		return true
	}
...
func (o *BulkUpdateProducts200Response) SetSchemaVersion(v string) {
	o.SchemaVersion = &v
}

// GetRequestId returns the RequestId field value if set, zero value otherwise.
func (o *BulkUpdateProducts200Response) GetRequestId() string {
...
// and a boolean to check if the value has been set.
func (o *BulkUpdateProducts200Response) GetRequestIdOk() (*string, bool) {
	if o == nil || IsNil(o.RequestId) {
		return nil, false
	}
...
func (o *BulkUpdateProducts200Response) HasRequestId() bool {
	if o != nil && !IsNil(o.RequestId) {
		return true
	}
...
func (o *BulkUpdateProducts200Response) SetRequestId(v string) {
	o.RequestId = &v
}

// GetUpdated returns the Updated field value if set, zero value otherwise.
func (o *BulkUpdateProducts200Response) GetUpdated() int32 {
...
// and a boolean to check if the value has been set.
func (o *BulkUpdateProducts200Response) GetUpdatedOk() (*int32, bool) {
	if o == nil || IsNil(o.Updated) {
		return nil, false
	}
...
func (o *BulkUpdateProducts200Response) HasUpdated() bool {
	if o != nil && !IsNil(o.Updated) {
		return true
	}
...
func (o *BulkUpdateProducts200Response) SetUpdated(v int32) {
	o.Updated = &v
}

func (o BulkUpdateProducts200Response) MarshalJSON() ([]byte, error) {
...
func (o BulkUpdateProducts200Response) ToMap() (map[string]interface{}, error) {
...
type NullableBulkUpdateProducts200Response struct {
	value *BulkUpdateProducts200Response
	isSet bool
}

func (v NullableBulkUpdateProducts200Response) Get() *BulkUpdateProducts200Response {
	return v.value
}

func (v *NullableBulkUpdateProducts200Response) Set(val *BulkUpdateProducts200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkUpdateProducts200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkUpdateProducts200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkUpdateProducts200Response(val *BulkUpdateProducts200Response) *NullableBulkUpdateProducts200Response {
	return &NullableBulkUpdateProducts200Response{value: val, isSet: true}
}

func (v NullableBulkUpdateProducts200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkUpdateProducts200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
