...
// checks if the GetDmarcSources200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDmarcSources200Response{}

// GetDmarcSources200Response struct for GetDmarcSources200Response
type GetDmarcSources200Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	Sources []GetDmarcSources200ResponseSourcesInner `json:"sources,omitempty"`
...
func NewGetDmarcSources200Response() *GetDmarcSources200Response {
	this := GetDmarcSources200Response{}
	return &this
}
...
func (o *GetDmarcSources200Response) GetSources() []GetDmarcSources200ResponseSourcesInner {
	if o == nil || IsNil(o.Sources) {
		var ret []GetDmarcSources200ResponseSourcesInner
		return ret
	}
	return o.Sources
}
...
// SetSources gets a reference to the given []GetDmarcSources200ResponseSourcesInner and assigns it to the Sources field.
...
func (o GetDmarcSources200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDmarcSources200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDmarcSources200Response struct {
	value *GetDmarcSources200Response
	isSet bool
}

func (v NullableGetDmarcSources200Response) Get() *GetDmarcSources200Response {
	return v.value
}

func (v *NullableGetDmarcSources200Response) Set(val *GetDmarcSources200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDmarcSources200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDmarcSources200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDmarcSources200Response(val *GetDmarcSources200Response) *NullableGetDmarcSources200Response {
	return &NullableGetDmarcSources200Response{value: val, isSet: true}
}

func (v NullableGetDmarcSources200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDmarcSources200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
