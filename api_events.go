...
func (r ApiTrackEventRequest) Execute() (*TrackEventResponse, *http.Response, error) {
	return r.ApiService.TrackEventExecute(r)
}

/*
TrackEvent Track a commerce event
...
func (a *EventsAPIService) TrackEventExecute(r ApiTrackEventRequest) (*TrackEventResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TrackEventResponse
	)
	...
	localVarPath := localBasePath + "/v1/events/track"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.trackEventRequest == nil {
		return localVarReturnValue, nil, reportError("trackEventRequest is required and must be specified")
	}
