...
// checks if the RunServerTest201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RunServerTest201Response{}

// RunServerTest201Response struct for RunServerTest201Response
type RunServerTest201Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	Test *ServerTest `json:"test,omitempty"`
}
...
// SetTest gets a reference to the given ServerTest and assigns it to the Test field.
func (o *RunServerTest201Response) SetTest(v ServerTest) {
	o.Test = &v
}

func (o RunServerTest201Response) MarshalJSON() ([]byte, error) {
...
func (o RunServerTest201Response) ToMap() (map[string]interface{}, error) {
...
type NullableRunServerTest201Response struct {
	value *RunServerTest201Response
	isSet bool
}

func (v NullableRunServerTest201Response) Get() *RunServerTest201Response {
	return v.value
}

func (v *NullableRunServerTest201Response) Set(val *RunServerTest201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRunServerTest201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRunServerTest201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunServerTest201Response(val *RunServerTest201Response) *NullableRunServerTest201Response {
	return &NullableRunServerTest201Response{value: val, isSet: true}
}

func (v NullableRunServerTest201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunServerTest201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
