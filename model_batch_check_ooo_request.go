...
// checks if the BatchCheckOooRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchCheckOooRequest{}

// BatchCheckOooRequest struct for BatchCheckOooRequest
type BatchCheckOooRequest struct {
	// Email addresses to check
	Emails []string `json:"emails"`
}

type _BatchCheckOooRequest BatchCheckOooRequest
...
func (o BatchCheckOooRequest) MarshalJSON() ([]byte, error) {
...
func (o BatchCheckOooRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["emails"] = o.Emails
	return toSerialize, nil
}

func (o *BatchCheckOooRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchCheckOooRequest := _BatchCheckOooRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchCheckOooRequest)

	if err != nil {
		return err
	}

	*o = BatchCheckOooRequest(varBatchCheckOooRequest)

	return err
}

type NullableBatchCheckOooRequest struct {
	value *BatchCheckOooRequest
	isSet bool
}

func (v NullableBatchCheckOooRequest) Get() *BatchCheckOooRequest {
	return v.value
}

func (v *NullableBatchCheckOooRequest) Set(val *BatchCheckOooRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchCheckOooRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchCheckOooRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchCheckOooRequest(val *BatchCheckOooRequest) *NullableBatchCheckOooRequest {
	return &NullableBatchCheckOooRequest{value: val, isSet: true}
}

func (v NullableBatchCheckOooRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchCheckOooRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
