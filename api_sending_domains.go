...
type ApiGetReplyForwardingRequest struct {
	ctx context.Context
	ApiService *SendingDomainsAPIService
	domainId string
}

func (r ApiGetReplyForwardingRequest) Execute() (*GetReplyForwarding200Response, *http.Response, error) {
	return r.ApiService.GetReplyForwardingExecute(r)
}

/*
GetReplyForwarding Get reply forwarding config

Get the reply forwarding configuration for a sending domain. Requires Growth+ plan.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param domainId Sending domain ID
 @return ApiGetReplyForwardingRequest
*/
func (a *SendingDomainsAPIService) GetReplyForwarding(ctx context.Context, domainId string) ApiGetReplyForwardingRequest {
	return ApiGetReplyForwardingRequest{
		ApiService: a,
		ctx: ctx,
		domainId: domainId,
...
func (a *SendingDomainsAPIService) GetReplyForwardingExecute(r ApiGetReplyForwardingRequest) (*GetReplyForwarding200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetReplyForwarding200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SendingDomainsAPIService.GetReplyForwarding")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/sending-domains/{domain_id}/reply-forwarding"
	localVarPath = strings.Replace(localVarPath, "{"+"domain_id"+"}", url.PathEscape(parameterValueToString(r.domainId, "domainId")), -1)
...
type ApiSetPrimarySendingDomainRequest struct {
	ctx context.Context
	ApiService *SendingDomainsAPIService
	domainId string
}

func (r ApiSetPrimarySendingDomainRequest) Execute() (*CreateSendingDomain201Response, *http.Response, error) {
	return r.ApiService.SetPrimarySendingDomainExecute(r)
}

/*
SetPrimarySendingDomain Set primary sending domain
...
Designate a domain as the primary/default sending domain. When domain_id is omitted from deliver calls, the primary domain is used automatically.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param domainId
 @return ApiSetPrimarySendingDomainRequest
*/
func (a *SendingDomainsAPIService) SetPrimarySendingDomain(ctx context.Context, domainId string) ApiSetPrimarySendingDomainRequest {
	return ApiSetPrimarySendingDomainRequest{
		ApiService: a,
		ctx: ctx,
		domainId: domainId,
...
// Execute executes the request
//  @return CreateSendingDomain201Response
func (a *SendingDomainsAPIService) SetPrimarySendingDomainExecute(r ApiSetPrimarySendingDomainRequest) (*CreateSendingDomain201Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SendingDomainsAPIService.SetPrimarySendingDomain")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/sending-domains/{domain_id}/set-primary"
	localVarPath = strings.Replace(localVarPath, "{"+"domain_id"+"}", url.PathEscape(parameterValueToString(r.domainId, "domainId")), -1)
...
type ApiUpdateReplyForwardingRequest struct {
	ctx context.Context
	ApiService *SendingDomainsAPIService
	domainId string
...
func (r ApiUpdateReplyForwardingRequest) UpdateReplyForwardingRequest(updateReplyForwardingRequest UpdateReplyForwardingRequest) ApiUpdateReplyForwardingRequest {
	r.updateReplyForwardingRequest = &updateReplyForwardingRequest
	return r
}

func (r ApiUpdateReplyForwardingRequest) Execute() (*GetReplyForwarding200Response, *http.Response, error) {
	return r.ApiService.UpdateReplyForwardingExecute(r)
}

/*
UpdateReplyForwarding Update reply forwarding config

Configure reply forwarding for a sending domain. Set forward_replies_to to null to disable. Requires Growth+ plan.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param domainId Sending domain ID
 @return ApiUpdateReplyForwardingRequest
*/
func (a *SendingDomainsAPIService) UpdateReplyForwarding(ctx context.Context, domainId string) ApiUpdateReplyForwardingRequest {
	return ApiUpdateReplyForwardingRequest{
		ApiService: a,
		ctx: ctx,
		domainId: domainId,
...
// Execute executes the request
//  @return GetReplyForwarding200Response
func (a *SendingDomainsAPIService) UpdateReplyForwardingExecute(r ApiUpdateReplyForwardingRequest) (*GetReplyForwarding200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SendingDomainsAPIService.UpdateReplyForwarding")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateReplyForwardingRequest == nil {
		return localVarReturnValue, nil, reportError("updateReplyForwardingRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateReplyForwardingRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
