...
// checks if the GetDomainInsightsFunnel200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDomainInsightsFunnel200Response{}

// GetDomainInsightsFunnel200Response struct for GetDomainInsightsFunnel200Response
type GetDomainInsightsFunnel200Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	Funnel map[string]interface{} `json:"funnel,omitempty"`
}

// NewGetDomainInsightsFunnel200Response instantiates a new GetDomainInsightsFunnel200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetDomainInsightsFunnel200Response() *GetDomainInsightsFunnel200Response {
	this := GetDomainInsightsFunnel200Response{}
	return &this
}

// NewGetDomainInsightsFunnel200ResponseWithDefaults instantiates a new GetDomainInsightsFunnel200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetDomainInsightsFunnel200ResponseWithDefaults() *GetDomainInsightsFunnel200Response {
	this := GetDomainInsightsFunnel200Response{}
	return &this
}

// GetSchemaVersion returns the SchemaVersion field value if set, zero value otherwise.
func (o *GetDomainInsightsFunnel200Response) GetSchemaVersion() string {
...
func (o *GetDomainInsightsFunnel200Response) GetSchemaVersionOk() (*string, bool) {
	if o == nil || IsNil(o.SchemaVersion) {
		return nil, false
	}
...
func (o *GetDomainInsightsFunnel200Response) HasSchemaVersion() bool {
	if o != nil && !IsNil(o.SchemaVersion) {
		return true
	}
...
func (o *GetDomainInsightsFunnel200Response) SetSchemaVersion(v string) {
	o.SchemaVersion = &v
}

// GetRequestId returns the RequestId field value if set, zero value otherwise.
func (o *GetDomainInsightsFunnel200Response) GetRequestId() string {
...
// and a boolean to check if the value has been set.
func (o *GetDomainInsightsFunnel200Response) GetRequestIdOk() (*string, bool) {
	if o == nil || IsNil(o.RequestId) {
		return nil, false
	}
...
func (o *GetDomainInsightsFunnel200Response) HasRequestId() bool {
	if o != nil && !IsNil(o.RequestId) {
		return true
	}
...
func (o *GetDomainInsightsFunnel200Response) SetRequestId(v string) {
	o.RequestId = &v
}

// GetFunnel returns the Funnel field value if set, zero value otherwise.
func (o *GetDomainInsightsFunnel200Response) GetFunnel() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *GetDomainInsightsFunnel200Response) GetFunnelOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Funnel) {
...
func (o *GetDomainInsightsFunnel200Response) HasFunnel() bool {
	if o != nil && !IsNil(o.Funnel) {
		return true
	}
...
func (o *GetDomainInsightsFunnel200Response) SetFunnel(v map[string]interface{}) {
	o.Funnel = v
}

func (o GetDomainInsightsFunnel200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDomainInsightsFunnel200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDomainInsightsFunnel200Response struct {
	value *GetDomainInsightsFunnel200Response
	isSet bool
}

func (v NullableGetDomainInsightsFunnel200Response) Get() *GetDomainInsightsFunnel200Response {
	return v.value
}

func (v *NullableGetDomainInsightsFunnel200Response) Set(val *GetDomainInsightsFunnel200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDomainInsightsFunnel200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDomainInsightsFunnel200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDomainInsightsFunnel200Response(val *GetDomainInsightsFunnel200Response) *NullableGetDomainInsightsFunnel200Response {
	return &NullableGetDomainInsightsFunnel200Response{value: val, isSet: true}
}

func (v NullableGetDomainInsightsFunnel200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDomainInsightsFunnel200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
