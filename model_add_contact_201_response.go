...
// checks if the AddContact201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddContact201Response{}

// AddContact201Response struct for AddContact201Response
type AddContact201Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	Contact map[string]interface{} `json:"contact,omitempty"`
}

// NewAddContact201Response instantiates a new AddContact201Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAddContact201Response() *AddContact201Response {
	this := AddContact201Response{}
	return &this
}

// NewAddContact201ResponseWithDefaults instantiates a new AddContact201Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAddContact201ResponseWithDefaults() *AddContact201Response {
	this := AddContact201Response{}
	return &this
}

// GetSchemaVersion returns the SchemaVersion field value if set, zero value otherwise.
func (o *AddContact201Response) GetSchemaVersion() string {
...
func (o *AddContact201Response) GetSchemaVersionOk() (*string, bool) {
	if o == nil || IsNil(o.SchemaVersion) {
		return nil, false
	}
...
func (o *AddContact201Response) HasSchemaVersion() bool {
	if o != nil && !IsNil(o.SchemaVersion) {
		return true
	}
...
func (o *AddContact201Response) SetSchemaVersion(v string) {
	o.SchemaVersion = &v
}

// GetRequestId returns the RequestId field value if set, zero value otherwise.
func (o *AddContact201Response) GetRequestId() string {
...
// and a boolean to check if the value has been set.
func (o *AddContact201Response) GetRequestIdOk() (*string, bool) {
	if o == nil || IsNil(o.RequestId) {
		return nil, false
	}
...
func (o *AddContact201Response) HasRequestId() bool {
	if o != nil && !IsNil(o.RequestId) {
		return true
	}
...
func (o *AddContact201Response) SetRequestId(v string) {
	o.RequestId = &v
}

// GetContact returns the Contact field value if set, zero value otherwise.
func (o *AddContact201Response) GetContact() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *AddContact201Response) GetContactOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Contact) {
...
func (o *AddContact201Response) HasContact() bool {
	if o != nil && !IsNil(o.Contact) {
		return true
	}
...
func (o *AddContact201Response) SetContact(v map[string]interface{}) {
	o.Contact = v
}

func (o AddContact201Response) MarshalJSON() ([]byte, error) {
...
func (o AddContact201Response) ToMap() (map[string]interface{}, error) {
...
type NullableAddContact201Response struct {
	value *AddContact201Response
	isSet bool
}

func (v NullableAddContact201Response) Get() *AddContact201Response {
	return v.value
}

func (v *NullableAddContact201Response) Set(val *AddContact201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAddContact201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAddContact201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddContact201Response(val *AddContact201Response) *NullableAddContact201Response {
	return &NullableAddContact201Response{value: val, isSet: true}
}

func (v NullableAddContact201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddContact201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
