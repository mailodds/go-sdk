...
// checks if the GetDmarcDomain200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDmarcDomain200Response{}

// GetDmarcDomain200Response struct for GetDmarcDomain200Response
type GetDmarcDomain200Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	Domain *GetDmarcDomain200ResponseDomain `json:"domain,omitempty"`
}
...
func NewGetDmarcDomain200Response() *GetDmarcDomain200Response {
	this := GetDmarcDomain200Response{}
	return &this
}
...
func (o *GetDmarcDomain200Response) GetDomain() GetDmarcDomain200ResponseDomain {
	if o == nil || IsNil(o.Domain) {
		var ret GetDmarcDomain200ResponseDomain
		return ret
	}
	return *o.Domain
}
...
// SetDomain gets a reference to the given GetDmarcDomain200ResponseDomain and assigns it to the Domain field.
func (o *GetDmarcDomain200Response) SetDomain(v GetDmarcDomain200ResponseDomain) {
	o.Domain = &v
}

func (o GetDmarcDomain200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDmarcDomain200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDmarcDomain200Response struct {
	value *GetDmarcDomain200Response
	isSet bool
}

func (v NullableGetDmarcDomain200Response) Get() *GetDmarcDomain200Response {
	return v.value
}

func (v *NullableGetDmarcDomain200Response) Set(val *GetDmarcDomain200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDmarcDomain200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDmarcDomain200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDmarcDomain200Response(val *GetDmarcDomain200Response) *NullableGetDmarcDomain200Response {
	return &NullableGetDmarcDomain200Response{value: val, isSet: true}
}

func (v NullableGetDmarcDomain200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDmarcDomain200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
