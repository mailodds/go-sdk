...
// checks if the ClassifyContent200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassifyContent200Response{}

// ClassifyContent200Response struct for ClassifyContent200Response
type ClassifyContent200Response struct {
	SchemaVersion *string `json:"schema_version,omitempty"`
	RequestId *string `json:"request_id,omitempty"`
	ContentCheck *ClassifyContent200ResponseContentCheck `json:"content_check,omitempty"`
}
...
func NewClassifyContent200Response() *ClassifyContent200Response {
	this := ClassifyContent200Response{}
	return &this
}
...
func (o *ClassifyContent200Response) GetContentCheck() ClassifyContent200ResponseContentCheck {
	if o == nil || IsNil(o.ContentCheck) {
		var ret ClassifyContent200ResponseContentCheck
		return ret
	}
...
// SetContentCheck gets a reference to the given ClassifyContent200ResponseContentCheck and assigns it to the ContentCheck field.
func (o *ClassifyContent200Response) SetContentCheck(v ClassifyContent200ResponseContentCheck) {
	o.ContentCheck = &v
}

func (o ClassifyContent200Response) MarshalJSON() ([]byte, error) {
...
func (o ClassifyContent200Response) ToMap() (map[string]interface{}, error) {
...
type NullableClassifyContent200Response struct {
	value *ClassifyContent200Response
	isSet bool
}

func (v NullableClassifyContent200Response) Get() *ClassifyContent200Response {
	return v.value
}

func (v *NullableClassifyContent200Response) Set(val *ClassifyContent200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableClassifyContent200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableClassifyContent200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassifyContent200Response(val *ClassifyContent200Response) *NullableClassifyContent200Response {
	return &NullableClassifyContent200Response{value: val, isSet: true}
}

func (v NullableClassifyContent200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassifyContent200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
